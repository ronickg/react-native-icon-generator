...
.SFSymbolsPreviewWireframe {fill:none;opacity:1.0;stroke:black;stroke-width:0.5}
 ...
 <g id="Symbols">
  ...
  <g id="Black-S" transform="matrix(1 0 0 1 2884.57 625.541)">
   <path class="monochrome-0 multicolor-0:systemBlueColor hierarchical-0:primary SFSymbolsPreviewWireframe" d="${extractIconPath(
     fixedSvgContent,
     2
   )}"/>
  </g>
...
function extractSvgPathsData(svgContent: string): string {
  ...
  const otherShapes =
    svgContent.match(/<(circle|rect|ellipse|polygon|polyline)[^>]*>/g) || [];
...
function extractIconPath(svgContent: string, pos: number): string {
